...
struct sja1105_l2_lookup_entry {
	u64 tsreg;         /* P/Q/R/S only - LOCKEDS=1 */
	u64 mirrvlan;      /* P/Q/R/S only - LOCKEDS=1 */
	u64 takets;        /* P/Q/R/S only - LOCKEDS=1 */
...
size_t sja1105_static_config_get_length(const struct sja1105_static_config *);
int sja1105_static_config_add_entry(const struct sja1105_table_header *hdr,
			const void *buf, struct sja1105_static_config *config);
...
enum sja1105_static_config_validity
sja1105_static_config_check_valid(const struct sja1105_static_config *);

enum sja1105_static_config_validity sja1105_static_config_unpack(const void *,
		ssize_t, struct sja1105_static_config *);
...
void sja1105_unpack(const void *buf, u64 *value, int start, int end, size_t len);
void sja1105_packing(void *buf, u64 *value, int start, int end,
